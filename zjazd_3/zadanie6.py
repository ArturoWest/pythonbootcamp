#zaimplementuj klase Basket umozliwiajaca dodawanie produktow w okreslonej liczni do koszyka. zaimplementuj metoda obliczajaca czlkowita wartosc koszyka oraz wypisujaca inforamcje o zawrtosci koszyka. dodanie dwa razy tego samego produktu do koszyka powinno stworzyc tylko jendka pozycje
